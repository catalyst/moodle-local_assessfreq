 ...
 * @return array
 */
function assessfreqsource_quiz_user_preferences() {

    $preferences['assessfreqsource_quiz_table_rows_preference'] = [
        'null' => NULL_NOT_ALLOWED,
        'default' => 20,
        'type' => PARAM_INT,
    ];

    $preferences['assessfreqsource_quiz_table_sort_preference'] = [
        'null' => NULL_NOT_ALLOWED,
        'default' => 'name_asc',
        'type' => PARAM_ALPHAEXT,
    ];
 ...
 */
function assessfreqsource_quiz_output_fragment_get_user_table($args): string {
    global $CFG, $PAGE;
    ...
    $perpage = get_user_preferences('assessfreqsource_quiz_table_rows_preference', 20);
    ob_start();
