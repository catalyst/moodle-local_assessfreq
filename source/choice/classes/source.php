 ...
 * Main source file
 *
 * @package   assessfreqsource_choice
 * @author    Simon Thornett <simon.thornett@catalyst-eu.net>
 * @copyright Catalyst IT, 2024
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace assessfreqsource_choice;
...
class source extends source_base {
    ...
    public function get_name() : string {
        return get_string("source:name", "assessfreqsource_choice");
    }
    ...
    public function get_user_capabilities() : array {
        return ['mod/choice:choose', 'mod/choice:view'];
    }
}
